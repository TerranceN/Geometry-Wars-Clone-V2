...
void main() {
    ...
    vec2 diffToCenter = oldPosition - (accTexSize / 2);
    ...
    newVelocity = oldVelocity + acceleration * uDeltaTime * 10000 - oldVelocity * uDeltaTime * 1 - normalize(diffToCenter) * uDeltaTime * 1000;
